...
var file_proto_exchange_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x32, 0xaa, 0x04, 0x0a, 0x0f, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65,
...
var file_proto_exchange_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
...
var file_proto_exchange_proto_depIdxs = []int32{
	...
	0,  // 8: exchange.ExchangeService.GetTrades:input_type -> exchange.GetTradesRequest
	3,  // 9: exchange.ExchangeService.GetWalletBalance:input_type -> exchange.GetWalletBalanceRequest
	8,  // 10: exchange.ExchangeService.StreamTickerData:input_type -> exchange.TickerRequest
	10, // 11: exchange.ExchangeService.GetSubDepositAddress:input_type -> exchange.GetSubDepositAddressRequest
	12, // 12: exchange.ExchangeService.GetAccountCoinsBalance:input_type -> exchange.AccountCoinsBalanceRequest
	15, // 13: exchange.ExchangeService.GetWithdrawalRecords:input_type -> exchange.WithdrawalRecordsRequest
	2,  // 14: exchange.ExchangeService.GetTrades:output_type -> exchange.GetTradesResponse
	7,  // 15: exchange.ExchangeService.GetWalletBalance:output_type -> exchange.GetWalletBalanceResponse
	9,  // 16: exchange.ExchangeService.StreamTickerData:output_type -> exchange.TickerResponse
	11, // 17: exchange.ExchangeService.GetSubDepositAddress:output_type -> exchange.GetSubDepositAddressResponse
	13, // 18: exchange.ExchangeService.GetAccountCoinsBalance:output_type -> exchange.AccountCoinsBalanceResponse
	17, // 19: exchange.ExchangeService.GetWithdrawalRecords:output_type -> exchange.WithdrawalRecordsResponse
