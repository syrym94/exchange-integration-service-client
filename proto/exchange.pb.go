...
var file_proto_exchange_proto_rawDesc = []byte{
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x8e, 0x05, 0x0a, 0x0f, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e,
...
var file_proto_exchange_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_proto_exchange_proto_goTypes = []interface{}{
	...
	nil,                                  // 22: exchange.WithdrawableAmountResponse.WithdrawableAmountsEntry
}
var file_proto_exchange_proto_depIdxs = []int32{
	...
	22, // 8: exchange.WithdrawableAmountResponse.withdrawableAmounts:type_name -> exchange.WithdrawableAmountResponse.WithdrawableAmountsEntry
	...
	2,  // 17: exchange.ExchangeService.GetTrades:output_type -> exchange.GetTradesResponse
	7,  // 18: exchange.ExchangeService.GetWalletBalance:output_type -> exchange.GetWalletBalanceResponse
	9,  // 19: exchange.ExchangeService.StreamTickerData:output_type -> exchange.TickerResponse
	11, // 20: exchange.ExchangeService.GetSubDepositAddress:output_type -> exchange.GetSubDepositAddressResponse
	13, // 21: exchange.ExchangeService.GetAccountCoinsBalance:output_type -> exchange.AccountCoinsBalanceResponse
	17, // 22: exchange.ExchangeService.GetWithdrawalRecords:output_type -> exchange.WithdrawalRecordsResponse
	21, // 23: exchange.ExchangeService.GetWithdrawableAmount:output_type -> exchange.WithdrawableAmountResponse
